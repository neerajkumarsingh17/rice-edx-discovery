...
class ProgramAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'uuid', 'title', 'type', 'partner', 'status', 'hidden', 'rice_subject_id')
    ...
    fields = (
        ...
        'enrollment_count', 'recent_enrollment_count', 'credit_value','rice_subject_id'
    )
...
class PathwayAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'uuid', 'org_name', 'partner', 'email', 'destination_url', 'pathway_type', "lms_id",)
